...
public class UserDAO {
    ...
    public void createNewUser(Users user) throws SQLException {
        String sql = "INSERT INTO users (uname, fname, lname, email, pw) VALUES (?, ?, ?, ?, ?)";
    ...
    public Users findUserByUsername(String name) throws SQLException {
        ...
        try(Connection connection = DatabaseConfig.getConnection();
            ...
            if (resultSet.next()) {
                ...
                user.setUserId(resultSet.getInt("uid"));  // Don't forget the ID!
    ...
    public int updateUser(Users user) throws SQLException {
        String sql = "UPDATE users SET uname = ?, fname = ?, lname = ?, email = ?, pw = ? WHERE uid = ?";
